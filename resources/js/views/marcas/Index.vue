        ...
        <div class="card">
            <div class="card-header bg-primary d-flex align-items-center">
                <h5 class="card-title mb-0 text-white flex-grow-1">
                    <i class="fas fa-award mr-1"></i> Lista de Marcas
                </h5>
                <button v-if="hasPermission('crear-marca')" type="button" class="btn btn-light btn-sm" @click="openCreateModal">
                    <i class="fas fa-plus-circle mr-1"></i> Nueva Marca
                </button>
            </div>
            <div class="card-body">
                <div class="input-group mb-3">
                    <input type="text" class="form-control" v-model="search" placeholder="Buscar marca..." @keyup.enter="loadItems(1)">
                            ...
                            <tr v-for="(item, index) in items.data" :key="item.id" class="text-center">
                                ...
                                <td>
                                    <div class="btn-group" role="group">
                                        ...
                                        <button v-if="hasPermission('editar-marca')" class="btn btn-warning btn-sm" title="Editar" @click="openEditModal(item)">
                                            <i class="fas fa-edit"></i>
                                        </button>
                                        <button v-if="hasPermission('borrar-marca')" class="btn btn-danger btn-sm" title="Eliminar" @click="deleteItem(item)">
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header bg-primary">
                        <h5 class="modal-title text-white"><i class="fas fa-plus"></i> Nueva Marca</h5>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header bg-warning">
                        <h5 class="modal-title text-white"><i class="fas fa-edit"></i> Editar Marca</h5>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header bg-info">
                        <h5 class="modal-title text-white"><i class="fas fa-eye"></i> Detalle Marca</h5>
...
async function loadItems(page = 1) {
    loading.value = true;
    try {
        const res = await marcaService.index({ page, search: search.value });
...
async function createItem() {
    ...
    Object.keys(formErrors).forEach(k => delete formErrors[k]);
    try {
        await marcaService.store(createForm);
...
async function updateItem() {
    ...
    Object.keys(formErrors).forEach(k => delete formErrors[k]);
    try {
        await marcaService.update(currentItem.value.id, editForm);
...
async function deleteItem(item) {
    ...
    try {
        await marcaService.destroy(item.id);
