        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="input-group mb-3">
                    <input type="text" class="form-control" v-model="search" placeholder="Buscar tipo..." @keyup.enter="loadItems(1)">
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header bg-primary">
                        <h5 class="modal-title text-white"><i class="fas fa-plus"></i> Nuevo Tipo</h5>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header bg-warning">
                        <h5 class="modal-title text-white"><i class="fas fa-edit"></i> Editar Tipo</h5>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header bg-info">
                        <h5 class="modal-title text-white"><i class="fas fa-eye"></i> Detalle Tipo</h5>
...
async function loadItems(page = 1) {
    loading.value = true;
    try {
        const res = await tipoService.index({ page, search: search.value });
...
async function createItem() {
    ...
    Object.keys(formErrors).forEach(k => delete formErrors[k]);
    try {
        await tipoService.store(createForm);
...
async function updateItem() {
    ...
    Object.keys(formErrors).forEach(k => delete formErrors[k]);
    try {
        await tipoService.update(currentItem.value.id, editForm);
...
async function deleteItem(item) {
    ...
    try {
        await tipoService.destroy(item.id);
