    ...
    <div>
        ...
        <div class="card">
            <div class="card-header bg-primary d-flex align-items-center">
                ...
                <button v-if="hasPermission('crear-categoria')" type="button" class="btn btn-light btn-sm" @click="openCreateModal">
                            ...
                            <tr v-for="(item, index) in items.data" :key="item.id" class="text-center">
                                ...
                                <td>
                                    <div class="btn-group" role="group">
                                        ...
                                        <button v-if="hasPermission('editar-categoria')" class="btn btn-warning btn-sm" title="Editar" @click="openEditModal(item)">
                                            <i class="fas fa-edit"></i>
                                        </button>
                                        <button v-if="hasPermission('borrar-categoria')" class="btn btn-danger btn-sm" title="Eliminar" @click="deleteItem(item)">
